...
export class Backend implements backendInterface {
    ...
    async addWasteEntry(arg0: string, arg1: number, arg2: string, arg3: string, arg4: string, arg5: string): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.addWasteEntry(arg0, arg1, arg2, arg3, arg4, arg5);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async deleteWasteEntry(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.deleteWasteEntry(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getMyWasteEntries(): Promise<Array<WasteEntry>> {
        if (this.processError) {
            try {
                const result = await this.actor.getMyWasteEntries();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
